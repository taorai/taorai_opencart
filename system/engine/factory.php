...
/*                                                                                    */
/*  Copyright © 2012-2016 by J.Neuhoff (www.mhccorp.com)                              */
/*                                                                                    */
...
final class Factory 
{
	...
	public function loadView( $route, $data=array() ) {
		...
		// Newer Opencart versions (2.2.0.0 or later) omit the '.tpl' which we need
		$template = $route . '.tpl';
