          ...
          <div class="well">
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
             ...
             <!--  <input type="submit" value="<?php //echo $button_login; ?>" class="btn btn-primary" /> -->
                <!-- <button type="submit" class="btn btn-primary login"> <?php //echo $button_login;?> </button> -->
                  <button type="submit" class="button login"><span><span><?php echo $button_login; ?></span></span></button>  <a href="<?php echo $forgotten; ?>"><?php echo $text_forgotten; ?></a>
              <?php if ($redirect) { ?>
