      ...
      <div class="row">
        ...
        <div class="product-view">
          ...
          <div class="product-essential">
           ...
           if ($price && $special) { ?>
           <div class="sale-label new-top-left"><?php echo $config->get('magikplatina_sale_labeltitle'); ?></div>
           <?php } }  ?>
           ...
           <?php if ($thumb) { ?>
            ...
            <div class="product-shop wow bounceInLeft animated <?php if ($config->get('magikplatina_productpage_cb')) { echo 'col-sm-5';} else { echo 'col-sm-8';}?>">
...
<?php */ ?>
          ...
          <?php  global $config; if ($config->get('magikplatina_productpage_cb')) { ?>
          <div class="product-additional col-sm-3 wow bounceInLeft animated">
          <div class="block-product-additional">
          <?php echo html_entity_decode($config->get('magikplatina_productpage_cbcontent'));?>
          </div>
          ...
          <?php }  ?>  
            ...
            <div class="col-sm-12 bounceInUp animated">
              ...
              <?php global $config; if ($config->get('magikplatina_product_ct')) { ?>
              <li><a href="#product_tabs_custom" data-toggle="tab"><?php echo $config->get('magikplatina_product_cttitle'); ?></a></li>
              <?php }?>

              <?php if ($config->get('magikplatina_product_ct2')) { ?>
              <li><a href="#product_tabs_custom1" data-toggle="tab"><?php echo $config->get('magikplatina_product_ct2title'); ?></a></li>
              <?php }?>
            ...
            <?php if ($config->get('magikplatina_product_ct')) { ?>
            <div class="tab-pane fade" id="product_tabs_custom">
            <?php echo html_entity_decode($config->get('magikplatina_product_ctcontent'));?>
            </div>
            <?php } ?>

            <?php if ($config->get('magikplatina_product_ct2')) { ?>
            <div class="tab-pane fade" id="product_tabs_custom1">
            <?php echo html_entity_decode($config->get('magikplatina_product_ct2content'));?>
            </div>
            <?php } ?> 
              ...
              <div class="box-additional">
                <div class="related-pro wow bounceInUp animated">
                  <div class="slider-items-products">
                      ...
                      <?php /* if($this->config->get('magikplatina_quickview_button') == 1) { ?>
