  ...
  <div id="collapse-shipping" class="panel-collapse collapse">
    <div class="panel-body">
      ...
      <div class="form-horizontal">
        ...
        <button type="button" id="button-quote" data-loading-text="<?php echo $text_loading; ?>" class="button btn1"><?php echo $button_quote; ?></button>
      </div>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['shipping_method']) {
				...
				html += '        <button type="button" class="btn btn-default button" data-dismiss="modal"><?php echo $button_cancel; ?></button>';
